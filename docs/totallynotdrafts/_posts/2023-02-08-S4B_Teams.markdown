...
Nothing fancy new here, just some well-known techniques, which work too often and companies are not aware off. The success rate for this kind of phishing / social engineering is very high.
...
When talking about Skype-for-Business (S4B) also the predecessor Lync is meant.
