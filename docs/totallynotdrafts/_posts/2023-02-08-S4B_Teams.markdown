...
Nothing fancy new here, just some well-known techniques, which work too often and companies are not aware off.
...
* S4B, allows user-enumeration via E-Mail address, even if external communication is prohibited
* Teams, if external communication is enabled, allows Userenumeration and attacker to send messages directly to employees
...
![NMAP](/assets/media/S4B/NTLM_Auth_2.png){:width="100%"} *Extracting Domaindata with Nmap*
![NTLMRecon](/assets/media/S4B/NTLM_Auth.png){:width="100%"} *Extracting Domaindata with NTLMRecon*
