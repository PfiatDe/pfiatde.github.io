...
![Code.exe signed by MS](/docs/assets/media/Code_C2/Code_Cert.png){:width="100%"}*Code.exe signed by MS*
...
![Github Device Code Authentication](/docs/assets/media/Code_C2/Code_Tunnel_Step1.png){:width="100%"}*Github Device Code Authentication*
