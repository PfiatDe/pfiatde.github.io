...
![Github Device Code Authentication](/docs/assets/media/Code_C2/Code_Tunnel_Step1.png){:width="75%"}
...
<video src="https://badoption.eu/docs/assets/media/Code_C2/PoC.mp4" controls="controls" style="width:100%; height:100%;">
</video>
...
![](/docs/assets/media/Code_C2/Code_C2_Processes.png){:width="100%"}
*Process tree*
